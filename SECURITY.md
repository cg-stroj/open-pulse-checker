...
- Rate limiting is applied to active auth/setup surfaces (`GET /api/v1/admin/auth/login`, `GET /api/v1/setup/status`, `POST /api/v1/setup/first-admin`) and monitor write surfaces; exceeded limits return HTTP 429.
