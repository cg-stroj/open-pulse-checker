...
@Component
@ConditionalOnProperty(prefix = "openpulse.alerting.slack", name = "enabled", havingValue = "true")
public class SlackAlertNotifier extends AbstractAlertNotifier {

    private final SlackAlertingProperties properties;

    public SlackAlertNotifier(RestClient.Builder restClientBuilder,
                              SlackAlertingProperties properties,
